...
namespace ProvissyTools
{
    ...
    public class LandscapeViewModel : NotificationObject
    {
        ...
        {
            get { return ProvissyToolsSettings.Current.Layout; }
            set
            {
                if (ProvissyToolsSettings.Current.Layout != value)
                {
                    ProvissyToolsSettings.Current.Layout = value;
        ...
        {
            get { return ProvissyToolsSettings.Current.BrowserZoomFactor; }
            set
            {
                if (ProvissyToolsSettings.Current.BrowserZoomFactor != value)
                {
            ...
            get
            {
                return new RelayCommand(() =>
                {
                    ...
                    var window = new MainContentWindow
                    {
                        ...
                        Width = ProvissyToolsSettings.Current.WindowWidth,
                        Height = ProvissyToolsSettings.Current.WindowHeight
                    };
                    window.Show();
